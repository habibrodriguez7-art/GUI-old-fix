...
function Library:Window(config)
    ...
    -- Auto-initialize after a delay to let all UI elements be created
    ...
    function WindowObject:AddTab(tabConfig)
        ...
        -- Map icon names to rbxassetids (common icons)
        local iconMap = {
            ["home"] = "rbxassetid://7733960981",
            ["fishing"] = "rbxassetid://7743878857",
            ["settings"] = "rbxassetid://7734053495",
            ["player"] = "rbxassetid://7743875962",
            ["star"] = "rbxassetid://7734068323",
            ["info"] = "rbxassetid://7733715400",
            ["globe"] = "rbxassetid://7733715400",
            ["target"] = "rbxassetid://7734068323",
            ["zap"] = "rbxassetid://7733960981",
        }
        ...
        function TabObject:AddSection(sectionTitle, isOpen)
            ...
            function SectionObject:AddToggle(toggleConfig)
                ...
                local default = toggleConfig.Default
                local configPath = noSave and nil or ("Toggles." .. title:gsub("%s+", "_"))
                
                self._library:CreateToggle(self._container, title, configPath, callback, noSave, default)
            ...
            function SectionObject:AddMultiDropdown(dropdownConfig)
                ...
                self._library:CreateMultiDropdown(self._container, title, nil, options, configPath, callback, uniqueId, default)
            ...
            function SectionObject:AddInput(inputConfig)
                ...
                self._library:CreateInput(self._container, title, configPath, default, callback)
            ...
            function SectionObject:AddButton(buttonConfig)
                ...
                self._library:CreateButton(self._container, title, callback)
            end
