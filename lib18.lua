...
function Library:CreateMultiDropdown(parent, title, imageId, items, configPath, onSelect, uniqueId, defaultValues)
    ...
    function updateVisibleItems()
        ...
        local endIdx = math.min(#filteredItems, startIdx + VISIBLE_ITEMS + 2) -- +2 for smooth scrolling buffer
    ...
    local function performSearch(filter)
        ...
        filterItems(filter)
        listContainer.CanvasPosition = Vector2.new(0, 0) -- Reset scroll to top
        updateListDisplay()
    end
