    ...
    function WindowObject:AddTab(tabConfig)
        ...
        function TabObject:AddSection(sectionTitle, isOpen)
            ...
            function SectionObject:AddToggle(toggleConfig)
                ...
                self._library:CreateToggle(self._container, title, configPath, callback, noSave)
            ...
            function SectionObject:AddDropdown(dropdownConfig)
                ...
                self._library:CreateDropdown(self._container, title, nil, options, configPath, callback, uniqueId)
            ...
            function SectionObject:AddInput(inputConfig)
                ...
                local defaultNum = tonumber(default) or 0
                
                self._library:CreateInput(self._container, title, configPath, defaultNum, callback)
